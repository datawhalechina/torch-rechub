...
def matching_data():
    ...
    return {"user_features": user_features, "item_features": item_features, "train_dl": train_dl, "val_dl": val_dl, "item_dl": item_dl, "test_user_x": test_user_x, "item_profile": item_profile}
...
def test_matching_e2e(model_class, matching_data):
    ...
    if model_name in ["DSSM", "YoutubeSBC", "MIND"]:
        ...
        params = {"user_features": user_features, "item_features": item_features, "user_params": {"dims": [32]}}
    elif model_name == "FaceBookDSSM":
        params = {"user_features": user_features, "item_features": item_features, "neg_item_feature": item_features, "user_params": {"dims": [32]}, "item_params": {"dims": [32]}}
        ...
        if model_name == "SINE":
            params["interest_extractor_params"] = {"dims": [32]}
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        trainer = MatchTrainer(model, optimizer_params={"lr": 0.01}, n_epoch=1, device='cpu', model_path=temp_dir)
