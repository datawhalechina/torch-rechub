...
sys.path.append("../..")
from data.session_based.preprocess_session_based import INTERNAL_ITEM_ID_FIELD
from data.session_based.preprocess_session_based import TEST_DATA_PREFIX
from data.session_based.preprocess_session_based import TRAIN_DATA_PREFIX
