...
def negative_sample(data, user_col, item_col, label_col, ratio, method_id=2):
    ...
    Args:
        ...
        item_col (str): item column name for negative sampling
        label_col (str): label column name
        ratio (int): negative sample ratio, >= 1
        method_id (int, optional): `{0 : "random sampling", 1: "sampling method used in word2vec", 2: "tencent RALM sampling"}`. Defaults to 2.

    Returns:
        pd.DataFrame: (user_id, item_id, label)
    """
